...
<section class="blog-hero-section set-bg pb-5" data-setbg="{{ asset('storage/courses/'.$course->user_id.'/'.$course->image) }}">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="bh-text">
                    ...
                    <ul>
                        ...
                        <li>{{ $formatManager->getDateFr($course->created_at) }}</li>
                        <li>Mis à jour le {{ $formatManager->getDateFr($course->updated_at) }}</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8 m-auto">
                <div class="bd-text">
                    ...
                    <div class="bd-more-pic">
                        <div class="row">
                            <div class="col-md-6">
                                <img src="{{ asset('storage/courses/'.$course->user_id.'/'.$course->image) }}" alt="">
                            </div>
                            <div class="col-md-6">
...
<section class="related-post-section spad">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="blog-item set-bg" data-setbg="{{ asset('storage/courses/'.$item->user_id.'/'.$item->image) }}">
                    <div class="bi-tag bg-gradient">{{ $item->category->name }}</div>
                    <div class="bi-text">
                        <h5><a href="{{ route('courses.show', [
                            'category' => $item->category->slug,
                            'slug' => $item->slug
                        ]) }}">{{ $item->title }}</a></h5>
                        <span><i class="fa fa-clock-o"></i> {{ $formatManager->getDateFr($item->updated_at) }}</span>
                    </div>
                </div>
            </div>
          @endforeach
