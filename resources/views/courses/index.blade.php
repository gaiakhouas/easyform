                        ...
                        <div class="course my-5 row">
                            <div class="col-lg-4">
                                <div class="about-pic">
                                    <a href="{{ route('courses.show', [
                                        ...
                                        <img src="{{ asset('storage/courses/' . $course->user_id . '/' . $course->image) }}"
                                            alt="Course img">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="about-text pt-0">
                                    <h3>{{ $course->title }}</h3>
                                    <p>{{ $course->subtitle }}</p>
                                    <p>Par {{ $course->user->name }}<b></b></p>
                                    <span class="tag"> {{ $course->category->name }}</span>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <p><b>{{ $course->price }} €</b></p>
                                <a href="{{ route('wishlist.store', $course->id)}}" ><i class="fas fa-heart fa-3x"></i></a>
                            </div>
                        </div>
                    @endforeach
                </div>
